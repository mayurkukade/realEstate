  ...
  return (
    <div className="w-full md:w-full h-full ">
      ...
      <div id="aboutUs" className="w-full">
        <div className="flex flex-wrap flex-row px-20 w-full gap-5 pt-8 pb-8  bg-[rgba(238,238,238,0.66)]">
          <div className="w-[350px] md-w-1/3 md:float-left">
            <h1 className="text-2xl text-[#353535] font-[lato] font-semibold pb-3">
              OUR FAVORITE QUOTE
            </h1>
            <p className="text-base text-[#353535] font-[Arial] pb-2">
          ...
          <div className="float-right w-[740px] text-[#353535]">
            <h1 className="text-2xl font-semibold font-[Lato]">ABOUT US</h1>
            <div className="pb-2 pt-2 text-base font-[Arial]">
              <span>
      ...
      <div className="px-20 text-center py-8 ">
        <div className="pb-4">
          <h1 className="md:text-[58px] text-[34px] font-[Lato] text-[rgb(53,53,53)]">
            OUR APPROACH
          </h1>
        </div>

        <div className="flex justify-center">
          <span className="text-base text-[#353535] font-[Arial] md:w-[600px]">
      ...
      <div className="relative py-4">
        <div className=" md:flex flex-row px-20 justify-center gap-8 text-center overflow-clip bg-gray-100 text-[#353535] relative p-10">
          <div className="md:w-1/3  ">
            <h1 className="text-[24px] pb-7 font-[Lato] md:pb-8 font-semibold">
          ...
          <div className="md:w-1/3 ">
            <h1 className="text-[24px] pb-4 md:pb-2 font-[Lato] font-semibold ">
          ...
          <div className="md:w-1/3">
            <h1 className="text-[24px] pb-7 md:pb-8 font-semibold font-[Lato]">TEAM APPROACH</h1>
      ...
      <div className="px-20 text-center py-10 ">
        <div className="pb-4">
          <h1 className="text-2xl text-[rgb(53,53,53)] font-[Lato] font-semibold">
            WHY CHOOSE US
          </h1>
        </div>
        <div className="flex justify-center">
        ...
        <div className="flex justify-center w-[700px] px-4 shadow-xl py-4 items-center bg-blue-200 border-0 rounded-md text-[#353535] transition-transform">
          {Data.map(
            (item, index) =>
              index === current && (
                <div key={index}>
                  <h1 className="pb-6 text-4xl flex font-[Lato] justify-center">
                    Testimonials
                  </h1>
                  <div>
                    <link
