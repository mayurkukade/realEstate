...
function CookiePolicy() {
  ...
  <div>
    ...
    <div className="flex gap-4 mt-8">
      ...
      <div className=" w-1/2 h-full flex flex-col gap-4">
        ...
        <div className="shadow-lg rounded-xl mt-52 p-4 shadow-indigo-700/70">
        ...
        <div className="shadow-lg rounded-xl p-4 mt-[1110px] shadow-indigo-700/70">
  ...
  <p className="mt-4 text-lg font-serif">Opting out does not mean you will not see advertising - it means you won’t see personalized advertising from the companies that participate in the opt-out programs. Also, if you delete cookies on your device after you opted out, you will need to opt-out again.</p>
        ...
        <div className="shadow-lg rounded-xl p-4 mt-[260px]  shadow-indigo-700/70">
  ...
  <p className="mt-4 text-lg font-serif">You can opt out of Google Analytics by visiting www.google.com/settings/ads or by downloading the Google Analytics opt-out browser add-on at https://tools.google.com/dlpage/gaoptout.</p>
      ...
      {/* right section */}
      <div className="shadow-lg w-1/2 h-1/2 flex flex-col gap-4">
        <div className="shadow-lg p-4 rounded-xl mt-[325px] shadow-indigo-700/70">
        ...
        <div className="shadow-lg rounded-xl p-4 mt-[520px] border-2 shadow-indigo-700/70">
        ...
        <div className="shadow-lg rounded-xl p-4 mt-[670px] shadow-indigo-700/70">
        ...
        <div className="shadow-lg rounded-xl mt-[880px] p-4 mb-10 shadow-indigo-700/70">
