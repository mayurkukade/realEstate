...
import { FaRegHeart, FaShare, FaExpandArrowsAlt } from "react-icons/fa";
import {
  FaEllipsisVertical,
  FaChartArea,
  FaHouseChimney,
          ...
          <div id="col2" className="w-full pl-6">
            ...
            >
              ...
              <div id="column2" className="p-2 justify-evenly space-y-4">
                <div className="flex">
                  <span className="mr-3 mt-1 text-gray-800">
                    <FaExpandArrowsAlt style={{ fontSize: 32 }} />
                  </span>
                  <div>
