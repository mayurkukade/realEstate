...
export function SalePropertyCardTwo() {
  ...
  return (
    <div
      id="cardHeading"
      className=" w-[1000px] border border-cyan-100 rounded-lg shadow-xl "
    >
      <div id="heading" className="px-4 pt-2">
      ...
      <div id="cardBody" className="flex  ">
        <div id="images" className="p-4  border-cyan-600">
        ...
        <div id="information" className="pl-6 mt-4 text-sm text-gray-900 ">
          ...
          >
            <div id="row1" className="flex py-2 px-1 justify-start">
              <div className="w-1/3">
                <div className="text-sm font-semibold">Super Built-Up Area</div>
            ...
            <div id="row3" className="flex py-2 px-1 justify-start">
              ...
              <div className="w-1/3">
                <div className="text-sm font-semibold">Type of Ownershipr</div>
                <div className="text-sm">text</div>
              </div>

              <div className="w-1/3">
                <div className="text-sm font-semibold">Age of Construction</div>
                <div className="text-sm">text</div>
              </div>
            </div>
          </div>
      ...
      <div id="cardFooter" className="flex justify-between p-4">
